...
def increment(d1, scale, d2):
    ...
    @param dict d1: the feature vector which is mutated.(d1 is the weight vector)
    @param float scale
    @param dict d2: a feature vector.(d2 is a feature vector that is derived from a review)
    """
